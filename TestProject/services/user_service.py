from util import format_name, is_valid_age, is_valid_email, setup_logger
from util.validators import is_valid_age

logger = setup_logger(__name__)

class User:
    """This class will represent the user in the system."""
