...
class Cat(Animal):
    ...
    def describe(self):
        ...
        base = super().describe()
        indoor = "indoor" if self.is_indoor else "not indoor"
    ...
    def list_available(self):
        ...
        for animal in self.animals:
            if not animal.is_adopted():
                unadoptedAnimals.append(animal)
        return unadoptedAnimals
...
def main():
    ...
    # TODO: Add a Cat
    shelter.add_animal(Cat("Garfield", 48, "Orange", True))

    # TODO: Add a Puppy
    shelter.add_animal(Puppy("Scrappy Doo", 564, "Great Dane"))

    # TODO: Add a ServiceDog
    shelter.add_animal(ServiceDog("Fido", 4, "Lab", "guide"))

    # TODO: Add a Kitten
    shelter.add_animal(Kitten("Stinky", 5, "Orange"))
